/**
 * Exporter Scales Extension
 */
if (typeof Exporter !== 'undefined') {
    Exporter.exportAllScalesToZip = async function(app) {
        ...
        try {
            for (const key of keys) {
                ...
                for (const [scaleId, scaleData] of scaleEntries) {
                    ...
                    // Minimal delay to ensure DOM updates, SVG serialization doesn't need paint
                    ...
                    const filename = `scale_${safeKey}_${safeScaleName}_${displayMode}_${safeFretspan}.jpg`;
